...
resume = ["Name: Nathan Dreak", "Age: 28", "Job: adventurer", "Family status: married", "childrens: yes"]
 
# Добавление в конец
resume.append("Wife's name: Elena Fisher")  
print(resume)
# Добавление в список по индексу
resume.insert(1, "Name of friend: Vikrot Salivan")  
print(resume)
# Добавление нескольких значений
resume.extend(["First game: Dreak's Fortune", "Second game: Among Thieves"])     
print(resume)
# Удаление последнего элемента
last_item = resume.pop()     
print(resume)
# Удаление конкретного элмента
resume.remove("Age: 28")      
print(resume)       
